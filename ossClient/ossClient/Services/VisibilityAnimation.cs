...
namespace WPF.Common
{
    ...
    public class VisibilityAnimation
    {
        ...
        /// Animation duration
        /// </summary>
        private const int AnimationDurationFodeIn = 20;
        private const int AnimationDurationFodeOut = 2000;
            ...
            object baseValue)
        {
            ...
            if (visibility == Visibility.Collapsed || visibility == Visibility.Hidden)
            {
                ...
                {
                    Duration = new Duration(TimeSpan.FromMilliseconds(AnimationDurationFodeOut))
                };
            ...
            else
            {
                doubleAnimation = new DoubleAnimation
                {
                    Duration = new Duration(TimeSpan.FromMilliseconds(AnimationDurationFodeIn))
                };
